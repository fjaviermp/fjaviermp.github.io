    ...
    <div class="content">
      ...
      <div class="texto-derecha">
        ...
        <div id="texto_present">
          ...
          <p>
            Me considero proactivo, colaborativo y me encanta trabajar en equipo para resolver problemas y
            encontrar soluciones ingeniosas. Pienso que lo mejor de resolver un problema es ¡La satisfacción
            después de ello!
          </p>
        </div>
